...
/**
 * Decodes base64 string to raw byte array
 */
...
/**
 * Converts Float32 input from microphone to Gemin-compatible PCM Blob.
 * Gemini expects 'audio/pcm;rate=16000' (Int16).
 */
